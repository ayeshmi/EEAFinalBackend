    ...
    <body>
      ...
      <form class="row1 form12" action="/api/auth/addItem" method="post" enctype="multipart/form-data" >
        ...
        <img src = "https://remede.com.au/wp-content/uploads/2016/11/iStock-472537538-Women-Health.jpg">
            ...
            <input type="text" class="form-control" id="inputAddress" placeholder="Enter item name"  name="name" value="${user.username}" disabled>
          
            <label for="inputAddress">Email</label>
            <input type="text" class="form-control" id="inputAddress" placeholder="Enter item price" name="price" value="${user.email}" disabled>

            <label for="inputAddress">Address</label>
            <input type="text" class="form-control" id="inputAddress" placeholder="Enter item price"  value="${user.address}" disabled>
             

            <label for="inputAddress">BithDay</label>
            <input type="text" class="form-control" id="inputAddress" placeholder="Enter item price"  value="${user.birthday}" disabled>
