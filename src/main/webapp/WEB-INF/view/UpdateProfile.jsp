...
<div >
        <form class="row1 form12" action="/api/auth/updateUser" method="POST">
            ...
            <img class='form-img22'  src="http://cdn.onlinewebfonts.com/svg/img_191958.png" alt='register' />
                ...
                <input type="text" class="form-control" id="inputAddress" placeholder="Username" value=${username} name="username" disabled>
              
                <label for="inputAddress">Email</label>
                <input type="text" class="form-control" id="inputAddress" placeholder="Email" name="email" value=${email} disabled>

                <label for="inputAddress">BirthDay</label>
                <input type="date" class="form-control" id="inputAddress" placeholder="BirthDay" name="birthday" >
