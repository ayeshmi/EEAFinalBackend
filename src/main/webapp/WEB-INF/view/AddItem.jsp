    ...
    <body>
      ...
      <form class="row1 form12" action="/api/auth/addItem" method="post" enctype="multipart/form-data" id="ayeshmi">
        ...
        <br></br>
            ...
            <textarea rows = "5" cols = "50" name = "description"  class="form-control form-control-lg" placeholder="Enter item description"></textarea>
            ...
            <textarea rows = "5" cols = "60" name = "suitableFor" class="form-control form-control-lg" placeholder="Enter suitable persons"></textarea>

            <label for="inputAddress">How to use</label>
            <textarea rows = "5" cols = "10" name = "howToUse" class="form-control form-control-lg" placeholder="Enter how to use this item"></textarea>


            <label for="inputAddress">Ingredients</label>
            <textarea rows = "5" cols = "10" name = "ingredients" class="form-control form-control-lg" placeholder="Enter item ingredients"></textarea>
