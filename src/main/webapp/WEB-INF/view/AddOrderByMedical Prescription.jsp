...
<jsp:include page="Navbar.jsp">
	...
	<form class="row1 form12" action="/api/auth/addOrderByPrescription" method="post"
		enctype="multipart/form-data" id="ayeshmi">
		<h1 id="headerTitle1">
			<b>Add Medical Prescription</b>
		</h1>
		<input hidden value=${email} name="email">
		<input hidden value=${username} name="username">
		<input hidden value=${id} name="id">
		<label for="inputAddress">Order name</label> <input
			type="text" class="form-control" id="inputAddress"
			placeholder="Enter item name" name="name" required>
   <br></br>
  <label for="inputAddress">Special Note</label> <input
			type="text" class="form-control" id="inputAddress"
			placeholder="Enter item name" name="note" required>
  <br></br>
  <label for="inputAddress">Prescription image</label> <input type="file"
